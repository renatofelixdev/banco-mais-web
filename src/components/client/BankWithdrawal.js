...
class BankWithdrawal extends Component {
            ...
            <div className="container">
                ...
                <div className="table-container mdl-grid" style={{ padding: '0px' }}>
                    <div className="mdl-cell mdl-cell--6-col">
                        <span className="mdl-layout-title">Saque [ Saldo {this.props.bankAccountSelect.balance}]</span>
                    </div>
                    <div className="mdl-cell mdl-cell--6-col">
                    ...
                    <div className="mdl-card mdl-shadow--2dp">
                        ...
                        <div className="mdl-card__actions mdl-card--border">
                            <input type="button" onClick={() => this.props.bankWithdrawal(this.props.user,
...
const mapDispatchToProps = dispatch => {
    return {
        bankWithdrawal: (user, bankAccount, value) =>{
            dispatch(BankOperationApi.bankWithdrawal(user, bankAccount, value));
        }
    }
}

BankWithdrawal.contextTypes = {
    store: PropTypes.object.isRequired
}

const BankWithdrawalContainer = connect(mapStateToProps, mapDispatchToProps)(BankWithdrawal);

export default BankWithdrawalContainer