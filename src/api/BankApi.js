...
export default class BankApi {
    ...
    // static newInterviewSchedule(){
    //     return dispatch => {
    //         dispatch(formInterviewSchedule(new InterviewSchedule(), new Notification()));
    //     }
    // }

    // static toJobInterviews(type, interviewSchedule){
    //     return dispatch => {
    //         dispatch(formInterviewSchedule(interviewSchedule, new Notification()));
    //         browserHistory.push('/gestao/'+type+'/agendamentos');
    //     }
    // }

    // static scheduling(type, id) {
    //     console.log(type, id);
    //     return dispatch => {
    //         var url = LIST_JOB_INTERVIEWS_JOB_OPPORTUNITY;
    //         if(type === 'horario-de-entrevista')
    //             url = LIST_JOB_INTERVIEWS_INTERVIEW_SCHEDULE;
    ...
    //         fetch(url.replace(":id", id), requestInfo)
    //             .then(response => {
    //                 if (response.ok) {
    //                     response.json().then(list => {
    //                         dispatch(alterProgressBar(false));
    //                         dispatch(listJobInterviews(list));
    //                         console.log(list);
    //                         return list;
    //                     });
    //                 } else {
